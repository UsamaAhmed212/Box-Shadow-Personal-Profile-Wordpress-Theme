...
class Contact_Form_7_Control extends Base_Data_Control {
	...
	public function enqueue() {
        // Styles
		wp_register_style( 'contact-form-7-control', ELEMENTOR_DIR_URI . '/elementor-controls-register/elementor-controls/contact-form-7-control/assets/css/contact-form-7-control.css', array(), '1.0.0', 'all' );
		wp_enqueue_style( 'contact-form-7-control' );
		
		// Scripts
		wp_register_script( 'contact-form-7-control', ELEMENTOR_DIR_URI . '/elementor-controls-register/elementor-controls/contact-form-7-control/assets/js/contact-form-7-control.js', array(), '1.0.0', 'all' );
	...
	public function boxshadow_contact_form_seven () {
		...
		if( $boxshadow_forms ) {
			...
			foreach ( $boxshadow_forms as $boxshadow_form ) {
				...
				$contactForm[$boxshadow_form->ID] = $boxshadow_form->post_title;
